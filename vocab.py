...
class VocabEntry(object):
    ...
    def to_input_tensor(self, sents: List[List[str]], device: torch.device) -> torch.Tensor:
        ...
        sents_var = torch.tensor(sents_t, dtype=torch.long).to(device)
...
def main():
    ...
    parser.add_argument("--train_src", default="data/train.fr", type=str, help="train source file")
    parser.add_argument("--train_tgt", default="data/train.en", type=str, help="train target file")
    parser.add_argument("--vocab_file", default="vocab.json", type=str, help="vocab file")
